...
class Ui_ServerWind(object):
    def setupUi(self, ServerWind):
        ...
        self.S_PrvtKeyLabel.setMaximumSize(QtCore.QSize(387, 16777215))
        self.S_PrvtKeyLabel.setObjectName("S_PrvtKeyLabel")
        self.verticalLayout_3.addWidget(self.S_PrvtKeyLabel)
        self.S_LeftTableLabel = QtWidgets.QLabel(ServerWind)
        self.S_LeftTableLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.S_LeftTableLabel.setObjectName("S_LeftTableLabel")
        self.verticalLayout_3.addWidget(self.S_LeftTableLabel)
        ...
        self.S_PblcKeyLabel.setMaximumSize(QtCore.QSize(387, 16777215))
        self.S_PblcKeyLabel.setObjectName("S_PblcKeyLabel")
        self.verticalLayout_2.addWidget(self.S_PblcKeyLabel)
        self.S_RightTableLabel = QtWidgets.QLabel(ServerWind)
        self.S_RightTableLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.S_RightTableLabel.setObjectName("S_RightTableLabel")
        self.verticalLayout_2.addWidget(self.S_RightTableLabel)
    ...
    def retranslateUi(self, ServerWind):
        ...
        self.S_LeftTableLabel.setText(_translate("ServerWind", "TextLabel"))
        self.label.setText(_translate("ServerWind", "Public key:"))
        self.S_PblcKeyLabel.setText(_translate("ServerWind", "TextLabel"))
        self.S_RightTableLabel.setText(_translate("ServerWind", "TextLabel"))
